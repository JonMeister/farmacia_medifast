    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cc', models.PositiveBigIntegerField(unique=True, validators=[django.core.validators.RegexValidator(code='invalid_cc', message='No es un número de documento válido', regex='^\\d{7,10}$')], verbose_name='Cédula ciudadania')),
