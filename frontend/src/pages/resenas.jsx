  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <div className="bg-white p-8 rounded-lg shadow-lg w-2xl max-w-3xl">
        <h1 className="text-2xl font-bold text-center mb-6">Reseñas</h1>
          ...
          {[...Array(3)].map((_, index) => (
            ...
            >
              ...
              <div className="flex-1 ml-6">
                ...
                <div className="font-semibold text-gray-700">Cajero:</div>
                <div className="text-gray-600">Nombre del cajero</div>
              </div>
            </div>
          ))}
        </div>
